    ...
    public partial class adminDashboard: Form
    {
        ...
        private void LoadDriverData()
        {
            try
            {
                ...
                string query = "SELECT COUNT(DISTINCT DriverName) AS TotalDrivers FROM [Kavishka].[dbo].[TransportUnits]";
        ...
        private void LoadTransportUnitData()
        {
            try
            {
                ...
                string query = "SELECT COUNT(DISTINCT TransportUnitID) AS TotalTransportUnits FROM [Kavishka].[dbo].[TransportUnits]";
        ...
        private void LoadCustomerData()
        {
            try
            {
                ...
                string query = "SELECT COUNT(DISTINCT CustomerID) AS TotalCustomers FROM [Kavishka].[dbo].[TransportOperations]";
